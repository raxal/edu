...
- [Конспект по теме Кривые второго порядка](../../docs/geometry/lection06_an.pdf)
- [Конспект по теме Классификация кривых второго порядка](../../docs/geometry/lection07_an.pdf)
- [Конспект по теме Поверхности второго порядка](../../docs/geometry/lection08_an.pdf)
